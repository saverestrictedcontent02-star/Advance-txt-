...
# Image URLs for the random image feature - REPLACED WITH NEW URL
image_urls = [NEW_IMAGE_URL]  # Only your new image
...
async def upload(bot: Client, m: Message):
    ...
    # FIXED: Check if user sent "3" for non-PW links
    if raw_text4 == '3':
